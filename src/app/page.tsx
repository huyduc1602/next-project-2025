  ...
  const features = [
    {
      ...
      description:
        "Optimized for speed with React 19 and Next.js 15, delivering lightning-fast experiences.",
      icon: "⚡️",
    },
    {
      id: "feature-2",
      ...
      description:
        "Built with the latest technologies for scalability, maintainability, and developer experience.",
      icon: "🏗️",
    },
    {
      id: "feature-3",
      ...
      description:
        "Beautiful UI that adapts seamlessly to any device size with Tailwind CSS.",
      icon: "📱",
    },
  ];
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                Blazing fast, beautifully designed, and built with the latest
                technologies.
              </p>
            </div>
